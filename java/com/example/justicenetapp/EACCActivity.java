...
public class EACCActivity extends AppCompatActivity {
    ...
    String[] counties = {"Uasin Gishu", "Nairobi", "Kiambu", "Kakamega"};
    String[] phoneNumbers = {"0715007700", "0783777700", "0727285663", "0733520641"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eaccactivity);
        ...
        txtnemaactivity.setOnClickListener(v -> openUrlInWebView("https://www.eacc.go.ke/"));


        cardviewback.setOnClickListener(v -> startActivity(new Intent(EACCActivity.this,RecordActivity.class)));
        cardViewcamera.setOnClickListener(v -> startActivity(new Intent(EACCActivity.this,CameraActivity.class)));
    ...
    private void showUploadDialog() {
        ...
        builder.setPositiveButton("Upload", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(EACCActivity.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    private void showEmergencyServiceDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(EACCActivity.this);
        builder.setTitle("Select Emergency Service");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(EACCActivity.this, android.R.layout.simple_list_item_1, emergencyServices);
    ...
    private void showCountyDialog() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(EACCActivity.this, android.R.layout.simple_list_item_1, counties);
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto:report@interity.go.ke"));
        try {
            startActivity(Intent.createChooser(emailIntent, "Send email..."));
        } catch (android.content.ActivityNotFoundException ex) {
            Toast.makeText(EACCActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    private void openUrlInWebView(String url) {
        Intent intent = new Intent(EACCActivity.this, WebViewActivity.class);
