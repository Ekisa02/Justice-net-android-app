...
public class KHRCActivity extends AppCompatActivity {
    ...
    String[] phoneNumbers = {"+254722264497"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khrcactivity);
        ...
        txtnemaactivity.setOnClickListener(v -> openUrlInWebView("https://www.khrc.or.ke/"));


        cardviewback.setOnClickListener(v -> startActivity(new Intent(KHRCActivity.this,RecordActivity.class)));
        cardViewcamera.setOnClickListener(v -> startActivity(new Intent(KHRCActivity.this,CameraActivity.class)));
    ...
    private void showUploadDialog() {
        ...
        builder.setPositiveButton("Upload", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(KHRCActivity.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    private void showEmergencyServiceDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(KHRCActivity.this);
        builder.setTitle("Select Emergency Service");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(KHRCActivity.this, android.R.layout.simple_list_item_1, emergencyServices);
    ...
    private void showCountyDialog() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(KHRCActivity.this, android.R.layout.simple_list_item_1, counties);
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto:admin@khrc.or.ke"));
        try {
            startActivity(Intent.createChooser(emailIntent, "Send email..."));
        } catch (android.content.ActivityNotFoundException ex) {
            Toast.makeText(KHRCActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    private void openUrlInWebView(String url) {
        Intent intent = new Intent(KHRCActivity.this, WebViewActivity.class);
