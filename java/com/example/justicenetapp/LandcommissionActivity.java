...
public class LandcommissionActivity extends AppCompatActivity {
    ...
    String[] phoneNumbers = {"0111042800"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_landcommission);
        ...
        txtnemaactivity.setOnClickListener(v -> openUrlInWebView("https://www.landcommission.go.ke/"));


        cardviewback.setOnClickListener(v -> startActivity(new Intent(LandcommissionActivity.this,RecordActivity.class)));
        cardViewcamera.setOnClickListener(v -> startActivity(new Intent(LandcommissionActivity.this,CameraActivity.class)));
    ...
    private void showUploadDialog() {
        ...
        builder.setPositiveButton("Upload", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(LandcommissionActivity.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    private void showEmergencyServiceDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LandcommissionActivity.this);
        builder.setTitle("Select Emergency Service");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(LandcommissionActivity.this, android.R.layout.simple_list_item_1, emergencyServices);
    ...
    private void showCountyDialog() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(LandcommissionActivity.this, android.R.layout.simple_list_item_1, counties);
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto:info@landcommission.go.ke"));
        try {
            startActivity(Intent.createChooser(emailIntent, "Send email..."));
        } catch (android.content.ActivityNotFoundException ex) {
            Toast.makeText(LandcommissionActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    private void openUrlInWebView(String url) {
        Intent intent = new Intent(LandcommissionActivity.this, WebViewActivity.class);
