...
public class NemaActivity extends AppCompatActivity {
    ...
    String[] counties = {"Uasin Gishu", "Nairobi", };
    String[] phoneNumbers = {"0724253398","0735013046"};
   ...
   // 15 MB
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardviewback = findViewById(R.id.cardRecord);


        txtnemaactivity.setOnClickListener(v -> openUrlInWebView("https://www.nema.go.ke/"));


        cardviewback.setOnClickListener(v -> startActivity(new Intent(NemaActivity.this,RecordActivity.class)));
        cardViewcamera.setOnClickListener(v -> startActivity(new Intent(NemaActivity.this,CameraActivity.class)));
    ...
    private void showUploadDialog() {
        ...
        builder.setPositiveButton("Upload", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(NemaActivity.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    private void showEmergencyServiceDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(NemaActivity.this);
        builder.setTitle("Select Emergency Service");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(NemaActivity.this, android.R.layout.simple_list_item_1, emergencyServices);
    ...
    private void showCountyDialog() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(NemaActivity.this, android.R.layout.simple_list_item_1, counties);
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto:info@nema.go.ke"));
        try {
            startActivity(Intent.createChooser(emailIntent, "Send email..."));
        } catch (android.content.ActivityNotFoundException ex) {
            Toast.makeText(NemaActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    private void openUrlInWebView(String url) {
        Intent intent = new Intent(NemaActivity.this, WebViewActivity.class);
